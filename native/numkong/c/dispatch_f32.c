...
void nk_dispatch_f32_find_(nk_capability_t v, nk_kernel_kind_t k, nk_kernel_punned_t *m, nk_capability_t *c) {
    ...
    if (v & nk_cap_haswell_k) switch (k) {
        ...
        case nk_kernel_maxsim_packed_stats_k:
            *m = (m_t)&nk_maxsim_packed_stats_f32_haswell, *c = nk_cap_haswell_k;
            return;
        default: break;
        }
#endif
    ...
    if (v & nk_cap_neonsdot_k) switch (k) {
        ...
        case nk_kernel_maxsim_packed_stats_k:
            *m = (m_t)&nk_maxsim_packed_stats_f32_neonsdot, *c = nk_cap_neonsdot_k;
            return;
        default: break;
        }
#endif
    ...
    if (v & nk_cap_serial_k) switch (k) {
        ...
        case nk_kernel_maxsim_packed_stats_k:
            *m = (m_t)&nk_maxsim_packed_stats_f32_serial, *c = nk_cap_serial_k;
            return;
        default: break;
        }
