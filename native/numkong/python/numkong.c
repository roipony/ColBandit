...
static PyMethodDef nk_methods[] = {
    ...
    {"colbandit_flat", (PyCFunction)api_colbandit_flat, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_flat},
    {"colbandit_full_inplace", (PyCFunction)api_colbandit_full_inplace, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_full_inplace},
    {"extract_flat_from_packed", (PyCFunction)api_extract_flat_from_packed, METH_FASTCALL | METH_KEYWORDS, doc_extract_flat_from_packed},
    {"total_tokens", (PyCFunction)api_total_tokens, METH_FASTCALL | METH_KEYWORDS, doc_total_tokens},
    {"full_maxsim", (PyCFunction)api_full_maxsim, METH_FASTCALL | METH_KEYWORDS, doc_full_maxsim},
    {"colbandit_maxsim", (PyCFunction)api_colbandit_maxsim, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim},
    {"colbandit_maxsim_fp32", (PyCFunction)api_colbandit_maxsim_fp32, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_fp32},
    {"maxsim_pack_int8", (PyCFunction)api_maxsim_pack_int8, METH_FASTCALL | METH_KEYWORDS, doc_maxsim_pack_int8},
    {"colbandit_maxsim_prequantized", (PyCFunction)api_colbandit_maxsim_prequantized, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_prequantized},
    {"colbandit_maxsim_optimized", (PyCFunction)api_colbandit_maxsim_optimized, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_optimized},
    {"colbandit_maxsim_unified", (PyCFunction)api_colbandit_maxsim_unified, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_unified},
    {"colbandit_maxsim_pure_fp32", (PyCFunction)api_colbandit_maxsim_pure_fp32, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_pure_fp32},
    {"colbandit_maxsim_f16", (PyCFunction)api_colbandit_maxsim_f16, METH_FASTCALL | METH_KEYWORDS, doc_colbandit_maxsim_f16},
    {"topm_maxsim", (PyCFunction)api_topm_maxsim, METH_FASTCALL | METH_KEYWORDS, doc_topm_maxsim},
    {"topm_flat", (PyCFunction)api_topm_flat, METH_FASTCALL | METH_KEYWORDS, doc_topm_flat},
    {"maxsim_pack_set_indices", (PyCFunction)api_maxsim_pack_set_indices, METH_FASTCALL | METH_KEYWORDS, doc_maxsim_pack_set_indices},
    {"maxsim_pack_set_4bit", (PyCFunction)api_maxsim_pack_set_4bit, METH_FASTCALL | METH_KEYWORDS, doc_maxsim_pack_set_4bit},
    {"centroid_maxsim", (PyCFunction)api_centroid_maxsim, METH_FASTCALL | METH_KEYWORDS, doc_centroid_maxsim},
    {"centroid4_maxsim", (PyCFunction)api_centroid4_maxsim, METH_FASTCALL | METH_KEYWORDS, doc_centroid4_maxsim},
    {"score_4bit_compact", (PyCFunction)api_score_4bit_compact, METH_FASTCALL | METH_KEYWORDS, doc_score_4bit_compact},
    {"score_i8_compact", (PyCFunction)api_score_i8_compact, METH_FASTCALL | METH_KEYWORDS, doc_score_i8_compact},
