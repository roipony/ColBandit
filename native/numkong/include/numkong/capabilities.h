...
typedef enum {
    ...
    nk_kernel_maxsim_packed_stats_k = 't', ///< MaxSim sum + sum_sq for Serfling bounds
...
NK_PUBLIC nk_capability_t nk_capabilities_x86_(void) {
    ...
    unsigned supports_avx512bw = (info7.named.edx & 0x00800000) != 0;
    ...
    unsigned supports_sapphire = supports_avx512bw;
